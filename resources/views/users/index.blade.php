            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <div class="mx-3">
                            <a href="{{ route('users.create') }}" class="btn bg-gradient-primary btn-sm mb-0">Add New {{ $tittle }}</a>
                        </div>
                    </li>
                </ul>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ $data->foto && $data->foto != 'default.png' ? asset('images/users/' . $data->foto) : asset('assets/img/team-2.jpg') }}" class="avatar avatar-sm me-3" alt="users1">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ route('users.edit', $data->id) }}" class="btn btn-link text-info px-2 mb-0" data-toggle="tooltip" title="Edit">
                                                    <i class="fas fa-pencil-alt text-info" style="font-size: 18px;"></i>
                                                </a>
                                                <form action="{{ route('users.destroy', $data->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Yakin hapus data ini?')">
                                                    @csrf
                                                    @method('DELETE')
